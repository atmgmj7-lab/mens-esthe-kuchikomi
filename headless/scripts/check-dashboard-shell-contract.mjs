...
assert.match(navigationSource, /href:\s*["']\/dashboard\/shops\/["']/);
assert.match(navigationSource, /href:\s*["']\/dashboard\/partners\/["']/);
assert.doesNotMatch(navigationSource, /\/dashboard\/(?:admin|imports|therapists)\//);
