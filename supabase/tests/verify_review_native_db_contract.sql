...
begin
  ...
  if not has_function_privilege('service_role', 'api.submit_review(bigint,text,smallint,text,text,text,text,timestamp with time zone,timestamp with time zone,smallint,smallint,smallint,text,text,text,uuid)', 'execute')
    ...
    or not has_table_privilege('service_role', 'app.reviews', 'select')
    or has_table_privilege('service_role', 'app.reviews', 'insert')
    or has_table_privilege('service_role', 'app.reviews', 'update')
    or has_table_privilege('service_role', 'app.reviews', 'delete')
    or has_table_privilege('service_role', 'app.reviews', 'truncate')
    or has_table_privilege('service_role', 'app.reviews', 'references')
    or has_table_privilege('service_role', 'app.reviews', 'trigger')
    or not has_column_privilege('service_role', 'app.reviews', 'shop_id', 'insert')
    or not has_column_privilege('service_role', 'app.reviews', 'body', 'insert')
    or not has_column_privilege('service_role', 'app.reviews', 'rating', 'insert')
    or not has_column_privilege('service_role', 'app.reviews', 'rating_price', 'insert')
    or not has_column_privilege('service_role', 'app.reviews', 'rating_service', 'insert')
    or not has_column_privilege('service_role', 'app.reviews', 'rating_cleanliness', 'insert')
    or not has_column_privilege('service_role', 'app.reviews', 'visit_period', 'insert')
    or not has_column_privilege('service_role', 'app.reviews', 'revisit_intent', 'insert')
    or has_column_privilege('service_role', 'app.reviews', 'source_type', 'insert')
    or has_column_privilege('service_role', 'app.reviews', 'moderation_status', 'insert')
    or has_column_privilege('service_role', 'app.reviews', 'publication_status', 'insert')
    or has_column_privilege('service_role', 'app.reviews', 'author_name', 'insert')
    or has_column_privilege('service_role', 'app.reviews', 'author_id', 'insert')
    or has_column_privilege('service_role', 'app.reviews', 'is_public', 'insert')
    or has_column_privilege('service_role', 'app.reviews', 'source_system', 'insert')
    or not has_column_privilege('service_role', 'app.reviews', 'moderation_status', 'update')
    or not has_column_privilege('service_role', 'app.reviews', 'publication_status', 'update')
    or not has_column_privilege('service_role', 'app.reviews', 'is_public', 'update')
    or not has_column_privilege('service_role', 'app.reviews', 'reviewed_at', 'update')
    or not has_column_privilege('service_role', 'app.reviews', 'approved_at', 'update')
    or not has_column_privilege('service_role', 'app.reviews', 'published_at', 'update')
    or not has_column_privilege('service_role', 'app.reviews', 'updated_at', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'body', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'rating', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'rating_price', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'rating_service', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'rating_cleanliness', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'visit_period', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'revisit_intent', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'shop_id', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'source_type', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'author_name', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'author_id', 'update')
    or has_column_privilege('service_role', 'app.reviews', 'source_system', 'update')
    or has_table_privilege('service_role', 'private.review_submission_details', 'update,delete')
    or has_table_privilege('service_role', 'private.review_idempotency_keys', 'update,delete')
    or has_table_privilege('service_role', 'private.review_abuse_rate_limits', 'delete')
